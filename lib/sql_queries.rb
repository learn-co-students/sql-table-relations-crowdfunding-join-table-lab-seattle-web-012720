...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT title, (sum(amount) - funding_goal) AS amount_over_goal from projects inner join pledges on projects.id = pledges.project_id where projects.funding_goal > sum(pledges.amount)"
end
